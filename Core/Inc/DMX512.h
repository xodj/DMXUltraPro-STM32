...
#define DMX_UART_U0 USART2
#define DMX_UART_U1 USART1
#define DMX_UART_U2 USART3
#define DMX_TX_PIN_U0 GPIO_PIN_2
#define DMX_TX_PIN_U1 GPIO_PIN_9
#define DMX_TX_PIN_U2 GPIO_PIN_10
#define DMX_TX_GPIO_PORT_U0 GPIOA
#define DMX_TX_GPIO_PORT_U1 GPIOA
#define DMX_TX_GPIO_PORT_U2 GPIOB
...
#define DMX_TX_HIGH_U2  HAL_GPIO_WritePin(DMX_TX_GPIO_PORT_U2,DMX_TX_PIN_U2,GPIO_PIN_SET)
...
#define DMX_TX_LOW_U2  HAL_GPIO_WritePin(DMX_TX_GPIO_PORT_U2,DMX_TX_PIN_U2,GPIO_PIN_RESET)
